  ...
  return (
    <div className="container mx-auto px-4 py-5">
        <div className="px-4 py-15 flex flex-col items-center text-center">
            ...
            <button className="bg-primary text-light-neutral-0 px-10 py-4 text-lg sm:text-xl rounded-2xl shadow-xl mt-2 transition-all duration-300 hover:bg-secondary transform hover:scale-105 hover:shadow-2xl cursor-pointer">Start  Exploring</button>
